...
function convert2(mediumUrl, filePath, fileIndex)
{
    ...
    fileName = fileName.replace("__BATTLE-IO---", "");
    fileName = fileName.replace("_Battle-IO---", "");
    fileName = fileName.replace("_battle-io---", "");
...
request({
    uri: "http://localhost/medium-backup/2017-10-14_Battle-IO---Setup-guide-table-of-content-8c773cd13dd2.html",
    method: 'GET'
  }, function (err, httpResponse, body) {
